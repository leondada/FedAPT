...
def get_domainnet_dloader(domain_name, batch_size, preprocess,num_workers=16):
    dataset_path = path.join('/home/share/DomainNet')
...
def get_domainnet_dloader_all(domain_name, batch_size,preprocess, num_workers=16):
    dataset_path = path.join('/home/share/DomainNet')
...
def get_domainnet_dataset(domain_name, batch_size,preprocess,preprocess_test,alpha=0.01,dom_clients=5,num_workers=8):
    dataset_path = path.join('/home/share/DomainNet')
    train_data_paths, train_data_labels = read_domainnet_data(dataset_path, domain_name, split="train")
    test_data_paths, test_data_labels = read_domainnet_data(dataset_path, domain_name, split="test")
    
    # train_dataset = DomainNet(train_data_paths, train_data_labels, transforms_train, domain_name)
    test_dataset = DomainNet(test_data_paths, test_data_labels, preprocess_test, domain_name)
